...
Bitmap chooseImage;
    ...
    public void upload (View view) {
        ...
        chooseImage.compress(Bitmap.CompressFormat.PNG,50,byteArrayOutputStream);
...
if ( e != null) {
    ...
    public void chooseImage (View view) { // kullanıcının galerisine gitmek için izin istemeli verdiyse kontrol etmeliyiz
